...
- Name: gui-main-path.spec.js >> 6) 超时：model-HANG + 短 timeout → 唯一终态 timeout
- Location: test\e2e\gui-main-path.spec.js:227:1
...
Call log:
  ...
  - waiting for locator('#status-text')
    62 × locator resolved to <span id="status-text">就绪</span>
       - unexpected value "就绪"
