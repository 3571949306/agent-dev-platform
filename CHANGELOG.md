...
- B25 Keyboard shortcuts: Ctrl+Shift+P palette · Ctrl+P Quick Open · Ctrl+N new chat (suppressed while typing to protect drafts) · Ctrl+J toggle bottom panel · Ctrl+B toggle sidebar · Ctrl+Shift+E left Files · Ctrl+Shift+R Problems. Enter/Shift+Enter composer behavior unchanged. Shortcuts chosen to avoid Electron default-menu accelerators.
