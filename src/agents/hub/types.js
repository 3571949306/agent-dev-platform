...
const ERROR_CODE = {
  ...
  AGENT_RUN_IDENTITY_MISMATCH: 'AGENT_RUN_IDENTITY_MISMATCH',
  AGENT_CANCEL_NOT_QUIESCED: 'AGENT_CANCEL_NOT_QUIESCED',
  AGENT_EFFECT_NOT_OBSERVED: 'AGENT_EFFECT_NOT_OBSERVED',
  AGENT_PROTOCOL_NOT_VERIFIED: 'AGENT_PROTOCOL_NOT_VERIFIED',
  AGENT_AUTH_REQUIRED: 'AGENT_AUTH_REQUIRED',
  AGENT_RUNTIME_FALLBACK: 'AGENT_RUNTIME_FALLBACK',
  AGENT_WORKSPACE_MISMATCH: 'AGENT_WORKSPACE_MISMATCH',
  EXTERNAL_SECRET_LEAK: 'EXTERNAL_SECRET_LEAK',
  AMBIGUOUS_EXTERNAL_AGENT_WINDOW: 'AMBIGUOUS_EXTERNAL_AGENT_WINDOW',
  EXTERNAL_AGENT_RESIDUE: 'EXTERNAL_AGENT_RESIDUE',
